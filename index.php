...
<html lang="ru">
	<head>
        ...
        <link rel="shortcut icon" href="<?php echo bloginfo('template_directory')."/assets/img"?>/favicons/favicon.ico" type="image/x-icon">
        <link rel="apple-touch-icon" href="<?php echo bloginfo('template_directory')."/assets/img"?>/favicons/apple-touch-icon.png">
        <link rel="apple-touch-icon" sizes="57x57" href="<?php echo bloginfo('template_directory')."/assets/img"?>/favicons/apple-touch-icon-57x57.png">
        <link rel="apple-touch-icon" sizes="72x72" href="<?php echo bloginfo('template_directory')."/assets/img"?>/favicons/apple-touch-icon-72x72.png">
        <link rel="apple-touch-icon" sizes="76x76" href="<?php echo bloginfo('template_directory')."/assets/img"?>/favicons/apple-touch-icon-76x76.png">
        <link rel="apple-touch-icon" sizes="114x114" href="<?php echo bloginfo('template_directory')."/assets/img"?>/favicons/apple-touch-icon-114x114.png">
        <link rel="apple-touch-icon" sizes="120x120" href="<?php echo bloginfo('template_directory')."/assets/img"?>/favicons/apple-touch-icon-120x120.png">
        <link rel="apple-touch-icon" sizes="144x144" href="<?php echo bloginfo('template_directory')."/assets/img"?>/favicons/apple-touch-icon-144x144.png">
        <link rel="apple-touch-icon" sizes="180x180" href="<?php echo bloginfo('template_directory')."/assets/img"?>/favicons/apple-touch-icon-180x180.png">
        <?php wp_head(); ?>
      </head>
    <body class="no-svg">
        <header>
                ...
                <div class="row align-items-center">
                    <div class="col-11 col-sm-12 col-md-12 col-lg-3">
                        <a href="#" class="header__logo">
                            <img src="<?php echo bloginfo('template_directory')."/assets/img"?>/icons/svg/logo.svg" alt="Мир детства" class="header__logo-img">
        ...
        <div class="mainslider glide">
            <div class="glide__track" data-glide-el="track">
                <ul class="glide__slides">
                    <li style="background-image: url('<?php echo bloginfo('template_directory')."/assets/img"?>/bg_1.jpg')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                    ...
                    <li style="background-image: url('<?php echo bloginfo('template_directory')."/assets/img"?>/bg_2.jpg')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                    ...
                    <li style="background-image: url('<?php echo bloginfo('template_directory')."/assets/img"?>/bg_3.jpg')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
                        <div class="about__img">
                            <img src="<?php echo bloginfo('template_directory')."/assets/img"?>/about.jpg" alt="про компанию">
                        </div>
                    </div>
        ...
        <div class="toys" id="toys">
            <div class="container">
                ...
                <div class="toys__wrapper">
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_directory')."/assets/img"?>/toy_1.jpg)">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_directory')."/assets/img"?>/toy_2.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_directory')."/assets/img"?>/toy_3.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_directory')."/assets/img"?>/toy_4.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_directory')."/assets/img"?>/toy_5.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_directory')."/assets/img"?>/toy_6.jpg)">
                        <div class="toys__item-info">
                ...
                <div class="toys__wrapper">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_directory')."/assets/img"?>/toy_7.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?php echo bloginfo('template_directory')."/assets/img"?>/toy_8.jpg)">
                        <div class="toys__item-info">
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php echo bloginfo('template_directory')."/assets/img"?>/about_1.jpg" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php echo bloginfo('template_directory')."/assets/img"?>/about_2.jpg" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                            Главное - качество
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php echo bloginfo('template_directory')."/assets/img"?>/about_3.jpg" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <a href="#" class="footer__logo">
                            <img src="<?php echo bloginfo('template_directory')."/assets/img"?>/icons/svg/logo.svg" alt="мир детства" class="footer__logo-img">
                    ...
                    <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                <img src="<?php echo bloginfo('template_directory')."/assets/img"?>/icons/svg/phone.svg" alt="телефон" class="footer__contacts-logo">
                            ...
                            <div class="footer__contacts-item">
                                <img src="<?php echo bloginfo('template_directory')."/assets/img"?>/icons/svg/pointer.svg" alt="указатель" class="footer__contacts-logo">
                                <address>ул. Василисы Кожиной, 1<br>
                                    Москва, Россия, 121096</address>
                            </div>
                        </div>
