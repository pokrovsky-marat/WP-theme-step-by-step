    ...
    <div class="glide__track" data-glide-el="track">
        <ul class="glide__slides">
            ...
            ?>
                ...
                <li style="background-image: url('<?php echo get_field('slider_img'); ?>')" class="glide__slide">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7 offset-1">
                                <h2 style="<?php if (get_field('slider_text_color') == 'light')
                                                echo 'color:#fff;' ?>" class="slider__title"><?php the_title(); ?></h2>
                                <?php if (get_field('slider_btn') == 'onn') { ?>
                                    <a href="<?php echo get_field('slider_link') ?>" class="button">Узнать больше</a>
                                <?php
                                } ?>
