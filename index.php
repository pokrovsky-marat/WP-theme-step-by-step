...
<div class="aboutus" id="aboutus">
    <div class="container">
        <h1 class="title"><?php the_field('history_heading', 2) ?></h1>
        <div class="row">
            <div class="col-lg-6">
                <div class="subtitle">
                    <?php the_field('history_sub_1', 2) ?>
                </div>
                <div class="aboutus__text"><?php the_field('history_descr_1', 2) ?></div>
            </div>
            <div class="col-lg-6">
                <img class="aboutus__img" src="<?php echo get_field('history_img_1', 2)['url']; ?>" alt="<?php echo get_field('history_img_1', 2)['alt']; ?>">
            </div>
        </div>

        <div class="row">
            <div class="col-lg-6">
                <img class="aboutus__img" src="<?php echo get_field('history_img_2', 2)['url']; ?>" alt="<?php echo get_field('history_img_2', 2)['alt']; ?>">
            </div>
            <div class="col-lg-6">
                <div class="subtitle">
                    <?php the_field('history_sub_2', 2) ?>
                </div>
                <div class="aboutus__text"><?php the_field('history_descr_2', 2) ?></div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="subtitle">
                    <?php the_field('history_sub_3', 2) ?>
                </div>
                <div class="aboutus__text"><?php the_field('history_descr_3', 2) ?></div>
            </div>
            <div class="col-lg-6">
                <img class="aboutus__img" src="<?php echo get_field('history_img_3', 2)['url']; ?>" alt="<?php echo get_field('history_img_3', 2)['alt']; ?>">
            </div>
        </div>
    </div>
</div>
...
<div class="contacts" id="contacts">
    <h1 class="title"><?php the_field('location_heading', 2) ?></h1>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="contacts__descr underlined">
                    <?php the_field('location_description', 2) ?>
                </div>
            </div>
            <div class="col-lg-6">
