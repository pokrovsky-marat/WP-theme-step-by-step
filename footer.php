    ...
    <div class="row align-items-center">
      ...
      <div class="col-md-4 col-lg-3">
        <div class="footer__social">
          ...
          <a href="<?php the_field('social_1'); ?>" class="footer__social-item">
          ...
          <a href="<?php the_field('social_2'); ?>" class="footer__social-item">
          ...
          <a href="<?php the_field('social_3'); ?>" class="footer__social-item">
